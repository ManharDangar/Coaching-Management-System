        ...
        <div class="dropdown-content">
          <div class="row">
            ...
            <div class="column">
                ...
                <a href="viewdata/viewdata_competative.php">MBA Enterance Coaching</a>
                <a href="viewdata/viewdata_competative.php">MCA Enterance Coaching</a>
                <a href="#">Medical enterance  Coaching</a>
                <a href="#">CET enterance  Coaching</a>
            </div>
            <div class="column">
                <h3>Other Exams</h3>
                <a href="viewdata/viewdata_competative.php">IBPS Exam Coaching</a>
                <a href="viewdata/viewdata_competative.php">UPSC Exam Coaching</a>
                <a href="viewdata/viewdata_competative.php">Staff Selection Comission Exam</a>
                <a href="viewdata/viewdata_competative.php">Bank Clerical Exam</a>
                <a href="viewdata/viewdata_competative.php">UGC NET Exam coaching</a>
            </div>
            <div class="column">
                <h3>More</h3>
                <a href="viewdata/viewdata_competative.php">All Exam coaching</a>
                <a href="viewdata/viewdata_competative.php">UPSC Exam Coaching</a>
                <a href="viewdata/viewdata_competative.php">Staff Selection Comission Exam</a>
                <a href="viewdata/viewdata_competative.php">Bank Clerical Exam</a>
                <a href="viewdata/viewdata_competative.php">UGC NET Exam coaching</a>
